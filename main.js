...
else if (itemQuantity > 10 && itemQuantity <=50){
document.getElementById ("display").innerHTML = (`You bought ${itemQuantity} ${ProductName} you will be paying #${itemQuantity*(itemPrice-discount40)} at 50% discount` );

}
else{
document.getElementById("display").innerHTML = (`See you some other time we dont have discount for  ${itemQuantity} bottles of ${ProductName} at the moment`);
